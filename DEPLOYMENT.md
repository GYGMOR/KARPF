# Deployment Anleitung für KARPF
...
git clone <GIT_REPO_URL> karpfgarten.ch
...
3. Website im Browser öffnen: http://karpfgarten.ch
...
```bash
sudo certbot --apache -d ackert.ch -d www.karpfgarten.ch
```
...
```bash
sudo chown -R www-data:www-data /var/www/karpfgarten.ch
sudo chmod -R 755 /var/www/karpfgarten.ch
```
