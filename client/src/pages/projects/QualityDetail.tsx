                ...
                <div className="container">
                    ...
                    <div className="max-w-4xl mx-auto text-center mb-24">
                        ...
                        <p className="text-[#5D4037] text-xl font-light leading-relaxed max-w-2xl mx-auto">
                            Hinter jedem Projekt von KARPFbau steht das Versprechen höchster Präzision und handwerklicher Meisterschaft.
                        </p>
                    </div>
                    ...
                    <div className="space-y-32 mb-32">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div className="order-2 lg:order-1">
                                ...
                                <p className="text-[#5D4037] text-lg font-light leading-relaxed mb-6">
                                    Ein Garten von KARPFbau ist kein kurzlebiger Trend. Es ist ein wertbeständiger Lebensraum, der mit den Jahren an Charakter gewinnt. Wir planen vorausschauend, damit Pflegeaufwand und Ästhetik in Harmonie bleiben.
                                </p>
                                <p className="text-[#5D4037] text-lg font-light leading-relaxed">
