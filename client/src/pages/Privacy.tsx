          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-10">
              ...
              <div className="text-[#5D4E37] space-y-2 mb-4">
                ...
                <p>KARPF</p>
                <p>Schlüsselackerstrasse 12b</p>
                <p>5614 Sarmenstorf</p>
                <p>Schweiz</p>
                <p>Telefon: 056 667 36 76</p>
                <p>E-Mail: <a href="mailto:info@karpfgarten.ch" className="text-primary hover:underline">info@karpfgarten.ch</a></p>
              </div>
            </section>
