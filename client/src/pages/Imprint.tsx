          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-10">
              ...
              <div className="text-[#5D4E37] space-y-2">
                <p className="font-semibold text-[#2D241E]">Büro:</p>
                <p>Schlüsselackerstrasse 12b, 5614 Sarmenstorf</p>
                <p className="font-semibold text-[#2D241E] mt-4">Magazin:</p>
                <p>Brunnmattstrasse, 5614 Sarmenstorf</p>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="text-[#5D4E37] space-y-2">
                <p>
                  ...
                  <a href="tel:0566673676" className="text-primary hover:underline">
                    056 667 36 76
                  </a>
                </p>
                <p>
                  <span className="font-semibold text-[#2D241E]">E-Mail:</span>{" "}
                  <a href="mailto:info@karpfgarten.ch" className="text-primary hover:underline">
                    info@karpfgarten.ch
                  </a>
                </p>
              </div>
