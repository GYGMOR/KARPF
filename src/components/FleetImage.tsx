                ...
                >
                    <div className="relative w-full h-[500px] md:h-[600px]">
                        <Image
                            ...
                            alt="KARPF Fuhrpark und Magazin"
                            fill
                            className="object-cover transform scale-105 group-hover:scale-100 transition-transform duration-[3s]"
                        />
                    </div>
                    ...
                    <div className="absolute bottom-8 left-8 right-8 text-white">
                        ...
                        <p className="text-gray-200 font-light max-w-2xl">
                            Immer einsatzbereit für Ihr Projekt. Von unserem Magazin in Sarmenstorf aus koordinieren wir unsere Einsätze in der gesamten Region.
                        </p>
                    </div>
                </motion.div>
            </div>
