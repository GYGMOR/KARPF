...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-[#2D241E]">
      {/* Video Background */}
      ...
      <div 
        ref={textRef}
        className="container relative z-10 flex flex-col items-center text-center mx-auto px-4"
      >
        <h1 className="font-display font-bold text-5xl md:text-7xl lg:text-8xl tracking-tight text-white mb-6 leading-tight text-shadow-sm">
          Natur in <br />
        ...
        <p className="max-w-2xl text-lg md:text-xl text-gray-100 mb-10 leading-relaxed font-light drop-shadow-md">
