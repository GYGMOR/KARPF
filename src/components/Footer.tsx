      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-20">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3">
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-2xl flex items-center justify-center group/logo hover:scale-105 transition-transform duration-500 relative w-48 h-24">
                <Image src="/images/logo.png" alt="KARPF Logo" fill className="object-contain p-2" />
              </div>
            </div>
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4 group">
                ...
                <div className="space-y-3">
                  <div className="text-[#D7CCC8] text-sm font-light block">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-8">
            <span className="text-[#D7CCC8]/60 text-xs font-light">
