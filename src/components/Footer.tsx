          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 text-sm">
              ...
              >
                ...
                <span className="font-semibold">056 667 36 76</span>
              </a>
              ...
              >
                ...
                <span className="font-semibold break-all">info@karpfgarten.ch</span>
              </a>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="text-sm">
                  <p className="font-body text-white/90 leading-relaxed">
                    ...
                    Schlüsselackerstrasse 12b<br />
                    5614 Sarmenstorf
                  </p>
                  <p className="font-body text-white/90 leading-relaxed mt-2">
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p className="text-white/70 font-body">
              © {currentYear} KARPF. Alle Rechte vorbehalten.
            </p>
