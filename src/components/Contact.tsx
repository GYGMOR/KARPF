              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-bold mb-1">Büro</h4>
                      <p className="text-gray-300 text-sm font-light">
                        Schlüsselackerstrasse 12b<br />5614 Sarmenstorf
                      </p>
                    </div>
                    <div>
                      <h4 className="font-bold mb-1">Magazin</h4>
                      <p className="text-gray-300 text-sm font-light">
                        Brunnmattstrasse<br />5614 Sarmenstorf
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:0566673676" className="text-gray-300 text-sm font-light hover:text-white transition-colors">056 667 36 76</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@karpfgarten.ch" className="text-gray-300 text-sm font-light hover:text-white transition-colors">info@karpfgarten.ch</a>
                  </div>
                </div>
              </div>
            </div>
